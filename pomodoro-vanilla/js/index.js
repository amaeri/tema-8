...
//JSON-formatet = et objekt (= {}). Adskiller properties (minutes/seconds) og value (25, 0) med komma
let timer
let time = {
    minutes: 25,
    seconds: 0
...
const showDuration = () => {
    let minutes = time.minutes < 10 ? '0' + time.minutes : time.minutes //if-funksjon
    let seconds = time.seconds < 10 ? '0' + time.seconds : time.seconds //if-funksjon
