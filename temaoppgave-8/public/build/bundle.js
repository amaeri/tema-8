...
var app = (function () {
    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			dispose = listen_dev(button, "click", /*click_handler_5*/ ctx[27], false, false, false);
    		},
    		p: noop,
    		d: function destroy(detaching) {
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			dispose = [
    				listen_dev(img0, "click", /*click_handler_1*/ ctx[23], false, false, false),
    				listen_dev(img0, "click", /*addTask*/ ctx[14], false, false, false),
    				listen_dev(img1, "click", /*click_handler_2*/ ctx[24], false, false, false),
    				listen_dev(img1, "click", /*addTask*/ ctx[14], false, false, false),
    				listen_dev(img2, "click", /*click_handler_3*/ ctx[25], false, false, false),
    				listen_dev(img2, "click", /*addTask*/ ctx[14], false, false, false),
    				listen_dev(img3, "click", /*click_handler_4*/ ctx[26], false, false, false),
    				listen_dev(img3, "click", /*addTask*/ ctx[14], false, false, false)
    			];
    		},
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*goal*/ 1 && input0.value !== /*goal*/ ctx[0]) {
    				set_input_value(input0, /*goal*/ ctx[0]);
    			}

    			if (!input1_updating && dirty[0] & /*cost*/ 4) {
    				set_input_value(input1, /*cost*/ ctx[2]);
    			}
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, img);
    			dispose = listen_dev(div, "animationend", /*fillPiggybank*/ ctx[15], false, false, false);
    		},
    		p: noop,
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!current || dirty[0] & /*goal*/ 1) set_data_dev(t5, /*goal*/ ctx[0]);
    			if (!current || dirty[0] & /*diff*/ 2048) set_data_dev(t9, /*diff*/ ctx[11]);
    		},
    		i: function intro(local) {
    			if (current) return;
